...
namespace RepairHouse.Controllers
{
    public class CargosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdCargo,Descripcion,FechaCreacion,Estado")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdCargo,Descripcion,FechaCreacion,Estado")] Cargo cargo)
        {
            if (ModelState.IsValid)
            {
